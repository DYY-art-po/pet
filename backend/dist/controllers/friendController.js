...
exports.deleteFriend = exports.rejectFriendRequest = exports.acceptFriendRequest = exports.getFriendRequests = exports.addFriend = exports.getFriends = void 0;
const sequelize_1 = require("sequelize");
const models_1 = __importDefault(require("../models"));
const Friendship = models_1.default.Friendship;
...
const getFriends = async (req, res) => {
    try {
        ...
        // 转换为好友列表
        const friends = friendships.map((friendship) => friendship.friendPet);
